...
modules to be used in Dancer session management, C<Dancer::Session::CHI> makes available the complete CHI::Driver::*
collection.

=head1 CONFIGURATION

C<Dancer::Session::CHI> accepts a C<use_plugin> option that defaults to 0. If set to 1, L<Dancer::Plugin::Cache::CHI>
